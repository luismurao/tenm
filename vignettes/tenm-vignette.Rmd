...
```
## Datasets included
Inside the package it is contain a data.frame with a set of occurrences presence records between 1939 and 2016 of "Abronia graminea", a lizard specie with a limited geographic distribution, endemic of Veracruz and Puebla.
...
## Plot ocurrence points in different years along a time series. 
